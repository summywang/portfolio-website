...
完整流程與中文狀態以內容庫的 [作品集工作流程](https://github.com/summywang/portfolio-content/blob/main/作品集工作流程.md) 為準。本文件提供「步驟 5：內容轉網頁準備」與「步驟 6：頁面製作與驗收」的實作細節；公開部署依「步驟 7：網站發布」處理，交付結果回記既有專案筆記。
