...
export const dealerPortal: CaseStudyData = {
  ...
  "problem": {
    "content": {
      "title": "關卡越來越長，技師難以走完整個診斷流程",
      "paragraphs": [
        "隨著系統升級，必要的診斷與更新項目持續增加，原有的逐關流程也越拉越長。工具擴充了檢查能力，卻逐漸難以配合技師現場的維修需求。"
      ],
      ...
      "pains": [
        {
          ...
          "body": "技師只能跟隨自動檢測逐步了解車況；一關卡住，後續問題便難以及時看見，也難以第一時間向車主說明車況、安排整體維修進程。"
        },
        {
          "title": "最想處理的問題，無法優先著手",
          "body": "即使想先修復馬達，技師仍可能得先排除另一個關卡的異常，才能繼續原本的維修工作，無法依現場需求自主安排處理順序。"
        },
        {
          "title": "進入總覽，仍找不到怎麼修、用什麼工具",
          "body": "總覽以靜態的部件資料占據主要版面，異常項目、診斷工具與支援資源不顯眼，技師仍得自行尋找下一步的維修入口。"
        }
      ]
    }
  },
